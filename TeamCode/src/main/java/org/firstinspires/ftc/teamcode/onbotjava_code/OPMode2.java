...
@TeleOp(name="OPMode2", group="Robot")
	...
	public void runOpMode() {
		...
		while (opModeIsActive()) {
			...
			if (up & !hang) {
				...
				armControlLeft.setTargetPosition(40);
				armControlRight.setTargetPosition(40);
			}

			
			if (hang) {
				armControlLeft.setTargetPosition(800);
				armControlRight.setTargetPosition(800);
				// armExtendLeft.setTargetPosition(50);
				// armExtendRight.setTargetPosition(50);
			...
			if (clawUp) {
				clawControl.setPosition(0.2);
			} else {
				clawControl.setPosition(0.39);
			}
